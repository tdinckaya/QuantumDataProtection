...
| Platform | Saglayici | Durum |
|----------|-----------|-------|
| Windows 11 / Server 2025 | Native .NET 10 | Destekleniyor |
| Linux (OpenSSL 3.5+) | Native .NET 10 | Destekleniyor |
| **macOS** | **BouncyCastle** | **Destekleniyor** |
| Eski Linux | BouncyCastle | Destekleniyor |
